...
const Home = () => {
  ...
  return (
    <div>
      ...
      {/* Quote Section */}
      <div className="quote-section py-5 text-center text-white" style={{backgroundColor: 'black'}}> {/* Added style attribute here */}
        <div className="container">
          <h1 className="mb-4">Your Dream Construction Starts Here</h1>
          <p className="lead">Get a quote for top-notch construction services for residential and commercial projects.</p>
        ...
        <div className="container text-center">
          ...
          <div className="row">
            <div className="col-md-4 mb-4">
              <div className="card">
                <img src="https://cdn-icons-png.flaticon.com/128/12612/12612690.png" className="card-img-top" alt="Stairs" style={{ width: '100%', height: 'auto', maxHeight: '200px', objectFit: 'contain' }} />
