        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/" className="flex items-center text-gray-300 hover:text-jjr-red">
                  <FaHome className="mr-2" size={18} />
                  Home
                </a>
              </li>
              <li>
                <a href="/about" className="flex items-center text-gray-300 hover:text-jjr-red">
                  <FaInfoCircle className="mr-2" size={18} />
                  About Us
                </a>
              </li>
              <li>
                <a href="/services" className="flex items-center text-gray-300 hover:text-jjr-red">
                  <FaTools className="mr-2" size={18} />
                  Services
                </a>
              </li>
              <li>
                <a href="/contact" className="flex items-center text-gray-300 hover:text-jjr-red">
